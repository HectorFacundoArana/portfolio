...
const Footer = () => {
    ...
    return(
        <>
            ...
            <a className='bg-black mb-4 bg-opacity-5 backdrop-blur-xl fixed bottom-0 left-1/2 transform -translate-x-1/2 z-50 border rounded-xl p-2  ' href="https://github.com/Aimbas" target='_blank' rel="noopener noreferrer">
